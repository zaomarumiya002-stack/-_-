...
[data-testid="stSidebar"] .stButton > button { height: 65px !important; font-size: 20px !important; border-radius: 10px !important; font-weight: 800 !important; background: #1E293B !important; color: #FFFFFF !important; border: 1px solid rgba(255,255,255,0.1) !important; transition: all .2s !important; margin-bottom: 8px !important; }
[data-testid="stSidebar"] .stButton > button:hover { background: #334155 !important; color: #fff !important; }
[data-testid="stSidebar"] .stButton > button[kind="primary"] { background: #F97316 !important; color: #fff !important; border-color: #EA580C !important; box-shadow: 0 4px 12px rgba(249,115,22,0.3) !important; }
...
[data-testid="stPills"] button { padding: 16px 30px !important; font-size: 24px !important; font-weight: 900 !important; border-radius: 12px !important; border: 2px solid #CBD5E1 !important; margin: 6px !important; min-height: 70px !important; line-height: 1.4 !important; transition: all .15s !important; text-align: center !important; }
[data-testid="stPills"] button[aria-selected="true"] { background: #F97316 !important; color: #fff !important; box-shadow: 0 4px 14px rgba(249,115,22,0.4) !important; border-color: #EA580C !important; }
/* ラジオボタンのUI調整 */
[data-testid="stRadio"] [role="radiogroup"] label p { font-size: 20px !important; font-weight: 900 !important; }
[data-testid="stRadio"] [role="radio"] { transform: scale(0.6); opacity: 0.7; margin-right: -4px; }
